...
export interface AssetTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "complianceOfficer",
    values?: undefined
  ): string;
...
export interface AssetToken extends BaseContract {
  ...
  complianceOfficer: TypedContractMethod<[], [string], "view">;
  ...
  setKYCStatus: TypedContractMethod<
    [user: AddressLike, verified: boolean, expirationDate: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "complianceOfficer"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    ...
    "KYCStatusUpdated(address,bool,uint256)": TypedContractEvent<
      KYCStatusUpdatedEvent.InputTuple,
      KYCStatusUpdatedEvent.OutputTuple,
      KYCStatusUpdatedEvent.OutputObject
    >;
