...
export const DiditKYCVerification: React.FC = () => {
    ...
    <View style={styles.stepContent}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setPersonalInfo({
            ...personalInfo, 
            address: {...personalInfo.address, street: text}
          })}
      ...
      <View style={styles.inputRow}>
        <View style={[styles.inputContainer, { flex: 1, marginRight: 8 }]}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setPersonalInfo({
              ...personalInfo, 
              address: {...personalInfo.address, city: text}
            })}
        ...
        <View style={[styles.inputContainer, { flex: 1, marginLeft: 8 }]}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setPersonalInfo({
              ...personalInfo, 
              address: {...personalInfo.address, state: text}
            })}
      ...
      <View style={styles.inputRow}>
        <View style={[styles.inputContainer, { flex: 1, marginRight: 8 }]}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setPersonalInfo({
              ...personalInfo, 
              address: {...personalInfo.address, zipCode: text}
            })}
            placeholder="12345"
        ...
        <View style={[styles.inputContainer, { flex: 1, marginLeft: 8 }]}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setPersonalInfo({
              ...personalInfo, 
              address: {...personalInfo.address, country: text}
            })}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>KYC Verification with Didit</Text>
